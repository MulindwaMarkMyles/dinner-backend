...
urlpatterns = [
    ...
    path('administrator/inventory/', admin_views.admin_inventory, name='admin_inventory'),
    path('administrator/inventory/add/', admin_views.add_drink, name='add_drink'),
    path('administrator/inventory/edit/<int:drink_id>/', admin_views.edit_drink, name='edit_drink'),
    path('administrator/inventory/delete/<int:drink_id>/', admin_views.delete_drink, name='delete_drink'),
    path('administrator/approvals/', admin_views.admin_approvals, name='admin_approvals'),
    path('administrator/approvals/approve/<int:order_id>/', admin_views.approve_order, name='approve_order'),
    path('administrator/approvals/deny/<int:order_id>/', admin_views.deny_order, name='deny_order'),
    path('administrator/users/', admin_views.admin_users, name='admin_users'),
    path('administrator/users/edit/<int:user_id>/', admin_views.edit_user, name='edit_user'),
    path('administrator/users/delete/<int:user_id>/', admin_views.delete_user, name='delete_user'),
